...
function Page() {
  ...
  return (
    <div className="bg-[#141414] flex flex-col justify-center items-center py-12 h-screen">
      <form
        onSubmit={handleSignUp}
        className="bg-[#212121] gap-y-[16px] border-[1px] border-white/15 rounded-xl flex flex-col w-[35%] h-screen py-4 md:px-8 px-3 justify-center"
      >
